...
So, if you want this to run for you on GitHub, you'll need to *copy* it in whole into a private repo (sorry, but GitHub will not let you make private forks of public repos) and enable the workflow there.
